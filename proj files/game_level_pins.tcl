...
#   set_location_assignment PIN_B12 -to CLOCK_50_2 ;# Global Clock 9
   ...
   set_location_assignment PIN_G3 -to read_dout ;# KEY1/BUTTON1 (mid button - half covered)
#   set_location_assignment PIN_F1 -to KEY2 ;# KEY2/BUTTON2 (left button)
...
#   set_location_assignment PIN_E3 -to SW[7] ;# SW[7]
   set_location_assignment PIN_E4 -to sel ;# SW[8]
   set_location_assignment PIN_D2 -to out_sel ;# SW[9]
   ...
   set_location_assignment PIN_J1 -to out[0] ;# LEDG[0]
   set_location_assignment PIN_J2 -to out[1] ;# LEDG[1]
   set_location_assignment PIN_J3 -to out[2] ;# LEDG[2]
   set_location_assignment PIN_H1 -to out[3] ;# LEDG[3]
   set_location_assignment PIN_F2 -to out[4] ;# LEDG[4]
   set_location_assignment PIN_E1 -to out[5] ;# LEDG[5]
   set_location_assignment PIN_C1 -to out[6] ;# LEDG[6]
   set_location_assignment PIN_C2 -to out[7] ;# LEDG[7]
   set_location_assignment PIN_B2 -to tx_ready ;# LEDG[8]
   set_location_assignment PIN_B1 -to rx_ready ;# LEDG[9] 
   ...
   set_location_assignment PIN_D13 -to dout_ready  ;# DP 
...
#   set_location_assignment PIN_A18 -to HEX2_DP  ;# DP 
   ...
   set_location_assignment PIN_G16 -to write  ;# DP 
